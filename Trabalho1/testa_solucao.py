...
class TestaSolucao(unittest.TestCase):
    def test_sucessor(self):
        ...
        succ_esperados = {("abaixo", "2435_1687"),
                          ("esquerda", "_23541687"), ("direita", "23_541687")}
        ...
        self.assertEqual(3, len(sucessores))
    ...
    def test_expande(self):
        ...
        :return:
        """
        pai = solucao.Nodo("185432_67", None, "abaixo",
                           2)  # o pai do pai esta incorreto, mas nao interfere no teste
        ...
        resposta = solucao.expande(pai)
        # verifica se foram retornados 2 nodos
        self.assertEqual(2, len(resposta))
        for nodo in resposta:
            # verifica se a tupla com os atributos do nodo esta' presente no conjunto com os nodos esperados
            self.assertIn((nodo.estado, nodo.pai, nodo.acao,
                          nodo.custo), resposta_esperada)
    ...
    def test_bfs(self):
        ...
        self.assertEqual(20, len(solucao.bfs("185432_67")))
        ...
        self.assertIsNone(solucao.bfs("2_5341687"))
    ...
    def test_astar_hamming(self):
        ...
        self.assertEqual(20, len(solucao.astar_hamming("185432_67")))
    ...
    def test_dfs(self):
        ...
        self.assertEqual(None, solucao.dfs("2_5341687"))
